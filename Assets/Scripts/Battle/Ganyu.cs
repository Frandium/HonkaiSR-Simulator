...
public class Ganyu : ACharacterTalents
{
    ...
    {
        float dmg = DamageCal.DamageCharacter(self, CommonAttribute.ATK, Element.Physical, 89.9f);
    ...
    {
        self.ClearEnergy();
        float dmg = DamageCal.DamageCharacter(self, CommonAttribute.ATK, Element.Cryo, 126 * 4);
    ...
    {
        float dmg = DamageCal.DamageCharacter(self, CommonAttribute.ATK, Element.Cryo, 238);
