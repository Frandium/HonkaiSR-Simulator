...
{    public Kazuha(Character _self): base(_self)
    ...
    {
        float dmg = DamageCal.DamageCharacter(self, CommonAttribute.ATK, Element.Physical, 88.9f);
    ...
    {
        float dmg = DamageCal.DamageCharacter(self, CommonAttribute.ATK, Element.Anemo, 472);
    ...
    {
        float dmg = DamageCal.DamageCharacter(self, CommonAttribute.ATK, Element.Anemo, 346) ;
